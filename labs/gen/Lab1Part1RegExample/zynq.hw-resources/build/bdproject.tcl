...
switch $TARGET {
  "Virtex7" {
    ...
    create_bd_port -dir I -from 31 -to 0 -type data dummy_raddr
    connect_bd_net [get_bd_ports dummy_raddr] [get_bd_pins SpatialIP_0/io_raddr]
    create_bd_port -dir I -type data dummy_wen
    connect_bd_net [get_bd_ports dummy_wen] [get_bd_pins SpatialIP_0/io_wen]
    connect_bd_net [get_bd_ports dummy_raddr] [get_bd_pins SpatialIP_0/io_waddr]
    connect_bd_net [get_bd_ports dummy_raddr] [get_bd_pins SpatialIP_0/io_wdata]
    create_bd_port -dir O -from 31 -to 0 -type data dummy_rdata
    connect_bd_net [get_bd_ports dummy_rdata] [get_bd_pins SpatialIP_0/io_rdata]
    create_bd_port -dir I dummyaxis
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_AWADDR]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_AWPROT]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_AWVALID]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_WDATA]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_WVALID]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_WSTRB]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_BREADY]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_ARADDR]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_ARPROT]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_ARVALID]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_S_AXI_RREADY]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_AWREADY]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_WREADY]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_BID]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_BRESP]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_BUSER]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_BVALID]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_ARREADY]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_RID]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_RDATA]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_RRESP]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_RLAST]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_RUSER]
    connect_bd_net [get_bd_ports dummyaxis] [get_bd_pins SpatialIP_0/io_M_AXI_0_RVALID]
    create_bd_port -dir O dummyout0
    connect_bd_net [get_bd_ports dummyout0] [get_bd_pins SpatialIP_0/io_S_AXI_RDATA]
    create_bd_port -dir O dummyout1
    connect_bd_net [get_bd_ports dummyout1] [get_bd_pins SpatialIP_0/io_S_AXI_RVALID]
  }
  default {
